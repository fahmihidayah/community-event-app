...
import { User, Mail, Phone, Calendar as AgeIcon, Briefcase, MapPin, Loader2, UserPlus, ArrowLeft, Users } from 'lucide-react'
...
export default function AddParticipantForm({ eventId }: AddParticipantFormProps) {
